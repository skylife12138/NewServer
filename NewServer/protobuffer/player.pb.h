...
PROTOBUF_NAMESPACE_OPEN
template<> ::player::TestProto* Arena::CreateMaybeMessage<::player::TestProto>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace player {
...
class TestProto :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:player.TestProto) */ {
 public:
  TestProto();
  virtual ~TestProto();
  ...
  // @@protoc_insertion_point(class_scope:player.TestProto)
 private:
  class _Internal;
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 TestProto::id() const {
  // @@protoc_insertion_point(field_get:player.TestProto.id)
  return _internal_id();
}
...
inline void TestProto::set_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:player.TestProto.id)
}
...
inline bool TestProto::isman() const {
  // @@protoc_insertion_point(field_get:player.TestProto.isman)
...
inline void TestProto::set_isman(bool value) {
  ...
  // @@protoc_insertion_point(field_set:player.TestProto.isman)
}
